package com.example.agenda_de_contactos.views
...
@Composable
fun EditarView(navController: NavController, viewModel: UsuariosViewModel, id: Int, usuario: String?, email: String?, numero: String?) {
    Scaffold(
        topBar = {
